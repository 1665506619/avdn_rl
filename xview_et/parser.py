...
def parse_args():
    ...
    parser.add_argument("--stop_th", type=float, default=0.5)
    parser.add_argument("--stop_iou_th", type=float, default=0.5)
    parser.add_argument("--stop_loss_w", type=float, default=1.0)
    ...
    parser.add_argument('--rl_lr', type=float, default=0.000005, help="the PPO fine-tuning learning rate")
    ...
    parser.add_argument('--ppo_iters', type=int, default=0, help='number of PPO fine-tuning updates')
    ...
    parser.add_argument('--ppo_value_w', type=float, default=0.5)
    parser.add_argument('--ppo_entropy_w', type=float, default=0.01)
    parser.add_argument('--ppo_il_w', type=float, default=0.05)
    parser.add_argument('--ppo_batch_episodes', type=int, default=8)
    parser.add_argument('--ppo_minibatch_size', type=int, default=32)
    parser.add_argument('--ppo_action_std_init', type=float, default=0.2)
    parser.add_argument('--step_penalty', type=float, default=-0.01)
    parser.add_argument('--delta_iou_reward', type=float, default=1.0)
    parser.add_argument('--success_stop_reward', type=float, default=2.0)
    parser.add_argument('--false_stop_penalty', type=float, default=-1.0)
    parser.add_argument('--overshoot_penalty', type=float, default=-0.5)
    parser.add_argument('--max_step_penalty', type=float, default=-1.0)
